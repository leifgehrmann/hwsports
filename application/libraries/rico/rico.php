...
class Client {
  ...
  static public $jsDir="/rico/js/";       // directory containing Rico's javascript files
  static public $cssDir="/rico/css/";     // directory containing Rico's css files
  static public $imgDir="/rico/images/";  // directory containing Rico's image files
