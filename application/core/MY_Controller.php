...
class MY_Controller extends CI_Controller {
    ...
    public function __construct() {
		...
		// Load all models
		foreach( array('centre_model', 'groups_model', 'matches_model', 'results_model', 'scheduling_model', 'sports_model', 'teams_model', 'tournaments_model', 'tournament_actors_model', 'users_model', 'venues_model', 'matches_model') as $modelName ) {
