<h1><a href="/tms/venues/">Venues</a><div class="icon subsection"></div><span id="title-name"><?=$this->data["venue"]["name"]?></span></h1>
<?=form_open("tms/venue/$venueID", array('id' => 'venueDetailsForm'))?>
<table>
	<tr>
		<td>Name</td>
	...
	<tr>
		<td>Directions</td>
		<td colspan="3"><?=form_textarea($directions)?></td>
	</tr>
	<tr>
		<td colspan="3"></td>
...
<script type='text/javascript'>
	$(document).ready(function() {
		$('#calendar').fullCalendar({
			...
			events: '/db_calendar/getVenueEventsTMS/<?=$venueID?>',
			editable: true,
