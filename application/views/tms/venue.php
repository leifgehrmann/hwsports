...
<?php
	...
	for($i=0;$i<count($fields);$i++){
		...
		echo "\t\t<td id='edit-{$fields[$i]}' style='display:none;width:{$widths[2]}'><button onclick='update(\"{$fields[$i]}\")'>Update</button><button onclick='cancel(\"{$fields[$i]}\")'>Cancel</button></td>";
		echo "\t</tr>";
	}
	echo "</table>";
?>
