...
class Assets extends MY_Controller {
	...
	public function load()
	{
		...
		function readBinaryFile($file) {
			if (file_exists($file)) {
				header("Content-Type: {Assets::$content_types[Assets::$file_ext]}");
