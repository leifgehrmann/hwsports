...
Rico.addPhraseId('sorting',"L'ordinamento è in progresso...");
...
Rico.addPhraseId('requestTimedOut',"La richiesta dei dati ha raggiunto il limite di tempo");
Rico.addPhraseId('waitForData',"Attendere per i dati...");
Rico.addPhraseId('httpError',"La richiesta ha generato un errore HTTP: $1");
Rico.addPhraseId('invalidResponse',"Il server ha restituito una risposta non valida");
...
Rico.addPhraseId('exportInProgress',"Esportazione in progresso...");
...
Rico.addPhraseId('selectNone',"(vuoto)");
Rico.addPhraseId('selectNewVal',"(nouvelle valeur)");
Rico.addPhraseId('record',"la registrazione");
Rico.addPhraseId('thisRecord',"questa registrazione");
Rico.addPhraseId('confirmDelete',"Siete sicuri che volete cancellare $1?");
Rico.addPhraseId('deleting',"L'annullamento è in progresso...");
Rico.addPhraseId('formPleaseEnter',"Per favore inserire un valore per $1");
Rico.addPhraseId('formInvalidFmt',"Formato non valida a $1");
Rico.addPhraseId('formOutOfRange',"Valeur fuori scala a $1");
Rico.addPhraseId('formNewValue',"nouvo valore:");
Rico.addPhraseId('saving',"i dati stanno conservandi...");
Rico.addPhraseId('clear',"cancella");
Rico.addPhraseId('close',"Chiudi");
Rico.addPhraseId('saveRecord',"Salva");
Rico.addPhraseId('cancel',"Annulla");
Rico.addPhraseId('editRecord',"Modifica questa registrazione");
Rico.addPhraseId('deleteRecord',"Cancella questa registrazione");
Rico.addPhraseId('cloneRecord',"Clona questa registrazione");
Rico.addPhraseId('addRecord',"Aggiungi una nuova registrazione");
Rico.addPhraseId('addedSuccessfully',"$1 ha aggiunto con successo");
Rico.addPhraseId('deletedSuccessfully',"$1 ha cancellato con successo");
Rico.addPhraseId('updatedSuccessfully',"$1 aggiornata con successo");

// used in ricoTree.js

Rico.addPhraseId('treeSave',"Salva la selezione");
Rico.addPhraseId('treeClear',"Deselezioni tutti");

// used in ricoCalendar.js

Rico.addPhraseId('calToday',"L'oggi è $1 $2 $3");
Rico.addPhraseId('calWeekHdg',"Set");
Rico.addPhraseId('calYearRange',"Anno ($1-$2)");
Rico.addPhraseId('calInvalidYear',"Anno non valida");
