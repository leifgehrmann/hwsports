...
Rico.onLoad( function() {
  ...
  buffer=new Rico.Buffer.AjaxSQL('ricoQuery.php', {TimeOut:<?php $c=session_get_cookie_params(); print $c["lifetime"]/60; ?>});
...
<a href='ricoQuery.php?id=ex2&offset=0&page_size=10&get_total=true'>View the AJAX response (XML)</a>.
</td>
<td>
<?php
//require "info.php";
