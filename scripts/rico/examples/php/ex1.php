...
<title>Rico LiveGrid sourced from HTML table</title>

<?php
error_reporting(E_ALL);
ini_set('display_errors', '1');
require "../../plugins/php/rico.php";
Rico\init(array('checkQueryString' => true));
Rico\renderHead();
...
Rico.onLoad( function() {
  ...
  var opts = {
    ...
    columnSpecs  : [{width:200},'specQty','specQty','specQty','specQty','specQty']
  };
  var ex1=new Rico.LiveGrid ('population', new Rico.Buffer.Base(document.getElementById('population').tBodies[0]), opts);
...
<hr>
This example demonstrates how Rico can convert an existing HTML table into
a much more usable LiveGrid.
LiveGrid provides scrolling, column resizing, filtering, and sorting capabilities.
...
<thead>
 <tr>
  <td class='ricoFrozen'></td>
  <td colspan=5>Population (thousands)</td>
 </tr>
 <tr>
  <td class='ricoFrozen'>Country or area</td>
  <td>1950</td>
  <td>2009</td>
  <td>2015</td>
  <td>2025</td>
...
<tbody>
 ...
 <tr>
  <td>Dem. Republic of the Congo</td>
  <td>12184</td>
  <td>66020</td>
  <td>77419</td>
  <td>98123</td>
